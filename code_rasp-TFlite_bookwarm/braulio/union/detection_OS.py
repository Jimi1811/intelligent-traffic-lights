...
# rutas de entrada para la deteccion
...
if __name__ == "__main__":
     ...
     while True:
          ...
          if int(loop_time) % 10 == 0: # cada 10 segundos
                ## estimar el nivel de trafico
                if Num_vehiculos < 3:
                    new_nivel = "bajo"
                elif Num_vehiculos < 6 and Num_vehiculos >= 3:
                    new_nivel = "medio"
                elif Num_vehiculos >= 6:
                    new_nivel = "alto"


          #cv2.putText(im, f'FPS: {fps:.2f} | Carros: {len(top_result)}',
          #             (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
          cv2.putText(im, f'N Carros: {len(top_result)}',
                       (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
          cv2.putText(im, f'nivel: {new_nivel}',
          ...
          #last_time = current_time # al desactivarlo te cuenta los fps como debe ser
